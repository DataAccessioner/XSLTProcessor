...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:da="http://dataaccessioner.org/schema/dda-1-1"
                xmlns:premis="info:lc/xmlns/premis-v2" xmlns:dcx="http://purl.org/dc/xml/" version="1.0">
    <xsl:output encoding="UTF-8" indent="yes" method="html" media-type="text/html" omit-xml-declaration="yes"
                ...
                <table border="1">
                    ...
                    <xsl:for-each select="premis:objectCharacteristics/premis:format">
                        <tr>
                            ...
                            <td>
                                <xsl:for-each select="premis:formatNote">
